...
func init() {
	proto.RegisterType((*MsgCreateGame)(nil), "czh0526.checkers.checkers.MsgCreateGame")
	proto.RegisterType((*MsgCreateGameResponse)(nil), "czh0526.checkers.checkers.MsgCreateGameResponse")
}
...
var fileDescriptor_b89f7ca8d0309536 = []byte{
	...
	,
	...
	0x94, 0x26, 0xe9, 0x25, 0xe7, 0xe7, 0xea, 0x43, 0x4d, 0xd5, 0x87, 0x87, 0x68, 0x05, 0x82, 0x59,
	0x52, 0x59, 0x90, 0x5a, 0x9c, 0xc4, 0x06, 0x0e, 0x60, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff,
	0xd2, 0x32, 0x4d, 0x77, 0x75, 0x01, 0x00, 0x00,
}
...
func (c *msgClient) CreateGame(ctx context.Context, in *MsgCreateGame, opts ...grpc.CallOption) (*MsgCreateGameResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/czh0526.checkers.checkers.Msg/CreateGame", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateGame_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/czh0526.checkers.checkers.Msg/CreateGame",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "czh0526.checkers.checkers.Msg",
